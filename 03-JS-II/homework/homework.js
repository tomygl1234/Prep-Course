...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  if(x === y){return x} else if(x > y) {return x} else {return y}
}
...
function esVerdadero(valor){
  ...
  if(valor === false){return "Soy falso"} else if(valor === true) {return "Soy verdadero"}
}
...
function tieneTresDigitos(numero){
  ...
  if(toString.length === 3){return true}
  return false
